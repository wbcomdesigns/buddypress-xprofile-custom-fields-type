	...
	class Bxcft_Field_Type_File extends BP_XProfile_Field_Type {
		...
		public function edit_field_html( array $raw_properties = array() ) {
			...
			if ( bp_get_the_profile_field_edit_value() != '' && bp_get_the_profile_field_edit_value() != '-' ) {
				$actual_file = sprintf(
					'%1$s<label for="%2$s_deletefile"><input type="checkbox" name="%2$s_deletefile" id="%2$s_deletefile" value="1" /> %3$s</label><input type="hidden" name="%2$s_hiddenfile" id="%2$s_hiddenfile" value="%4$s" />',
